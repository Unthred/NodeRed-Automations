<script type="text/javascript">
    RED.nodes.registerType('lgtv-mute', {
        category: 'lgtv',
        color: '#C0DEED',
        outputs: 1,
        inputs: 1,
...
<script type="text/x-red" data-template-name="lgtv-mute">
    <div class="form-row">
...
<script type="text/x-red" data-help-name="lgtv-mute">
    <p>Sound Mute</p>
    <p><code>msg.payload</code> is boolean <code>true</code> or <code>false</code></p>
</script>
