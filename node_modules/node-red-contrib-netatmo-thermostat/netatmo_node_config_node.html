...
<script type="text/javascript">
    console.log("registering netatmo config node for thermostat");
        RED.nodes.registerType('NetatmoConfigNode',{
            category: 'config',
            defaults: {
...
<script type="text/x-red" data-template-name="NetatmoConfigNode">
    <div class="form-row">
